...
namespace Orchard.CRM.Core.Services {
    ...
    public class OrchardCollaborationEmailMessageChannelSelector : Component, IMessageChannelSelector
    {
        ...
        public OrchardCollaborationEmailMessageChannelSelector(IWorkContextAccessor workContextAccessor)
        {
        ...
        {
            if (messageType == OrchardCollaborationSmtpMessageChannel.MessageType)
            {
    ...
    public class OrchardCollaborationSmtpMessageChannel : Component, ISmtpChannel, IDisposable {
        ...
        public static readonly string MessageType = "OrchardCollaboration.Email";

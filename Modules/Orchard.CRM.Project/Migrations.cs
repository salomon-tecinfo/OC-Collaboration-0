...
namespace Orchard.CRM.Project
{
    public class Migrations : DataMigrationImpl
    {
        ...
        public int Create()
        {
            ...
            // StringFieldIndexRecord index
            orchardProjectionModuleBuilder.AlterTable("StringFieldIndexRecord", table => table.CreateIndex(
                "StringFieldIndexRecord_MainIndex",
                new string[] 
                { 
            ...
            // IntegerFieldIndexRecord index
            orchardProjectionModuleBuilder.AlterTable("IntegerFieldIndexRecord", table => table.CreateIndex(
                "IntegerFieldIndexRecord_MainIndex",
                new string[] 
                { 
                    "FieldIndexPartRecord_Id",
                    "PropertyName",
            ...
            // DoubleFieldIndexRecord index
            orchardProjectionModuleBuilder.AlterTable("DoubleFieldIndexRecord", table => table.CreateIndex(
                "DoubleFieldIndexRecord_MainIndex",
                new string[] 
                { 
                    "FieldIndexPartRecord_Id",
                    "PropertyName",
            ...
            // DecimalFieldIndexRecord index
            orchardProjectionModuleBuilder.AlterTable("DecimalFieldIndexRecord", table => table.CreateIndex(
                "DecimalFieldIndexRecord_MainIndex",
                new string[] 
                { 
                    "FieldIndexPartRecord_Id",
                    "PropertyName",

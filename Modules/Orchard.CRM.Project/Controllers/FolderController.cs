...
namespace Orchard.CRM.Project.Controllers
{
    ...
    public class FolderController : BaseController
    {
        public FolderController(
            ...
            : base(ContentTypes.FolderContentType, "Folder_Edit", indexProvider, services, crmContentOwnershipService, transactionManager, extendedContentManager, contentManager, partSerializationManager, widgetService, themeAwareViewEngine, shapeFactory, displayHelperFactory, basicDataService, contentOwnershipHelper, activityStreamService, contentItemDescriptorManager)
        {

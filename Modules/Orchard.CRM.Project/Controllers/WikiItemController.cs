...
namespace Orchard.CRM.Project.Controllers
{
    ...
    public class WikiItemController : BaseController
    {
        public WikiItemController(
            ...
            : base(ContentTypes.WikiItemType, "WikiItem_Edit", indexProvider, services, crmContentOwnershipService, transactionManager, extendedContentManager, contentManager, partSerializationManager, widgetService, themeAwareViewEngine, shapeFactory, displayHelperFactory, basicDataService, contentOwnershipHelper, activityStreamService, contentItemDescriptorManager)
        {

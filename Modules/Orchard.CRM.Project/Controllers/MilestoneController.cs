...
namespace Orchard.CRM.Project.Controllers
{
    public class MilestoneController : BaseController
    {
        ...
        public MilestoneController(
            ...
            : base(ContentTypes.ProjectContentType, "Milestone_Edit", indexProvider, services, crmContentOwnershipService, transactionManager, extendedContentManager, contentManager, partSerializationManager, widgetService, themeAwareViewEngine, shapeFactory, displayHelperFactory, basicDataService, contentOwnershipHelper, activityStreamService, contentItemDescriptorManager)
        {

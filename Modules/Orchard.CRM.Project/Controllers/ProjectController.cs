...
namespace Orchard.CRM.Project.Controllers
{
    ...
    public class ProjectController : BaseController
    {
        ...
        public ProjectController(
            ...
            : base(ContentTypes.ProjectContentType, "Project_Edit", indexProvider, services, crmContentOwnershipService, transactionManager, extendedContentManager, contentManager, partSerializationManager, widgetService, themeAwareViewEngine, shapeFactory, displayHelperFactory, basicDataService, contentOwnershipHelper, activityStreamService, contentItemDescriptorManager)
        {

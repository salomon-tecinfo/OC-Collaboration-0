...
namespace Orchard.CRM.Project.Controllers
{
    public class FollowerController : BaseController
    {
        public FollowerController(
            ...
            : base(ContentTypes.ProjectContentType, "Followers_Edit", indexProvider, services, crmContentOwnershipService, transactionManager, extendedContentManager, contentManager, partSerializationManager, widgetService, themeAwareViewEngine, shapeFactory, displayHelperFactory, basicDataService, contentOwnershipHelper, activityStreamService, contentItemDescriptorManager)
        {
